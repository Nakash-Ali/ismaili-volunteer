defmodule VolunteerWeb.Admin.MarketingRequestController do
  ...
  def new(conn, _params) do
    ...
    VolunteerWeb.Services.Analytics.track_event("Listing", "admin_marketing_request_new", Slugify.slugify(listing), conn)
  ...
  def create(conn, %{"marketing_request" => marketing_request}) do
    ...
    |> case do
      {:ok, _} ->
        VolunteerWeb.Services.Analytics.track_event("Listing", "admin_marketing_request_create", Slugify.slugify(listing), conn)
