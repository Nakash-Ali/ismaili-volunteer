defmodule VolunteerWeb.Admin.FeedbackController do
  ...
  def index(conn, _params) do
    ...
    canny_user = VolunteerWeb.Services.Canny.get_user_config(conn, admin_feedback_anonymize)

    canny_assigns = VolunteerWeb.Services.Canny.get_config("admin", canny_user)
