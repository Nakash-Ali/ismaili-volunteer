...
do_create_group.(3, "Aga Khan Education Board Ontario", ontario)
do_create_group.(4, "Aga Khan Health Board (AKHBO) Ontario", ontario)
do_create_group.(5, "ITREB Ontario", ontario)
do_create_group.(6, "Economic Planning Board (EPB) Ontario", ontario)
do_create_group.(7, "Aga Khan Youth & Sports Board (AKYSB) Ontario", ontario)
